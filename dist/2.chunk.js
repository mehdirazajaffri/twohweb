...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__apiServices_auth_service__ = __webpack_require__(328);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__apiServices_global_service__ = __webpack_require__(219);
...
var ShoppingCartComponent = (function () {
    ...
    ShoppingCartComponent.prototype.scrapper = function () {
        var _this = this;
        var data = {
            url: $("#url").val()
        };
        if (data.url) {
            this.Api.scrap(data)
                .subscribe(function (data) {
                if (data.price) {
                    _this.transform($("#price").attr('ng-reflect-model', data.price.replace(/[^0-9,.]/, "")));
                    _this.transform($("#price").attr('value', data.price.replace(/[^0-9,.]/, "")));
                    _this.transform($("#price").val(data.price.replace(/[^0-9,.]/, "")));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_forms__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__apiServices_nav_scroll_service__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__apiServices_brands_service__ = __webpack_require__(329);
